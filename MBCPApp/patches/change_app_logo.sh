...
select opt in 'MB Classic' 'Tet' 'Valentine 2025' 'SemiMonet' '30/4-1/5' '19/8-2/9 2025' 'Summer 2025' 'Mid-autumn festival' 'Noel' 'Exit'
do
    case "$opt" in
	...
	'19/8-2/9 2025') variant="quockhanh2025" ;;
        ...
        'Mid-autumn festival') variant="trungthu" ;;
        'Noel') variant="noel" ;;
        'Exit') exit ;;
    esac
