...
PS3='Select app icon variant to continue, or [0] to exit : '
select opt in 'MB Classic' 'New Year 2023' 'Valentine 2025' 'SemiMonet' '30/4-1/5' '19/8-2/9 2025' 'Summer 2025' 'Mid-autumn festival 2025' 'Noel 2024'; do
  if [ "$REPLY" = "0" ]; then
    exit
  fi
