...
unpack_mbcp() {
    ...
    unzip -l mbapk/MBOriginal.apk | grep -oH "flutter_assets" && good "Current app is Flutter!" || { err "Current converted app is not Flutter, or too outdated, cannot continue! Deleting files..." ; rm -rf mbapk/* ; return 1 ;
    } 
